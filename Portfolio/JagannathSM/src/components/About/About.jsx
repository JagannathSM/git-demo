...
const About = () => {
  const handleDownloadCV = () => {
    const driveLink = "https://google.com";
    ...
    <AboutContainer id="about">
      <MainAbout2>
        <AboutContent>
          ...
          <h2>Hi I'm Jagannath</h2>
          <CombinedTitle>
          Emerging MERN Developer Focused on <br/> Web 3 & Innovation
          {/* Emerging MERN Stack Developer Exploring Web 3 and Digital Innovation */}
            {/* Creating digital <br />
          ...
          <ScoialIcon>
            <a href="https://github.com/JagannathSM" target="_blank" rel="noopener noreferrer">
              <FaSquareGithub />
            </a>
            <a href="https://www.linkedin.com/in/jagannath-sm" target="_blank" rel="noopener noreferrer">
              <FaLinkedin />
            </a>
          </ScoialIcon>
          <ButtonContainer>
